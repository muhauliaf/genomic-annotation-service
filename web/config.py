...
class Config(object):
  ...
  AWS_S3_KEY_PREFIX = f"mauliafirmansyah/"
  AWS_S3_ACL = "private"
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "mauliafirmansyah_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "mauliafirmansyah_job_results"
  AWS_SNS_JOB_ARCHIVE_TOPIC = \
    "mauliafirmansyah_job_archive"
  AWS_SNS_JOB_RESTORE_TOPIC = \
    "mauliafirmansyah_job_restore"
  AWS_SNS_JOB_THAW_TOPIC = \
    "mauliafirmansyah_job_thaw"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "mauliafirmansyah_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "mauliafirmansyah@mpcs-cc.com"

  # Time before free user results are archived (in seconds)
  FREE_USER_DATA_RETENTION = 300

  # Maximum file upload size for free user (in bytes)
  FREE_USER_UPLOAD_SIZE_LIMIT = 150 * 1024
